# edu-course-system-v2

✳仅提供思路，实际内容基于ai生成，仅供参考
---
...
之前的废稿（基于黑马苍穹外卖风格）是典型的 **“过程式三层架构”**。而 V2.0 是 **“领域驱动的规格引擎架构”**。
...
现在的项目结构是 `common`, `pojo`, `server`。对于 V2.0，我们需要更清晰的**职责划分**，建议采用以下模块化方案：
